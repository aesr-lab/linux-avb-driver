...
#define AVB_AEM_CMD_DEREGISTER_UNSOLICITED_NOTIFICATION (0x25)
#define AVB_AEM_CMD_IDENTIFY_NOTIFICATION (0x26)
#define AVB_AEM_CMD_GET_AVB_INFO (0x027)
#define AVB_AEM_CMD_GET_AS_PATH (0x028)
