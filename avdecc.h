...
#define AEM_STREAM_INFO_FLAGS_CLASS_B				0x00000001
#define AEM_STREAM_INFO_FLAGS_FAST_CONNECT			0x00000002
#define AEM_STREAM_INFO_FLAGS_SAVED_STATE			0x00000004
#define AEM_STREAM_INFO_FLAGS_STREAMING_WAIT		0x00000008
#define AEM_STREAM_INFO_FLAGS_SUPPORTS_ENCRYPTED	0x00000010
#define AEM_STREAM_INFO_FLAGS_ENCRYPTED_PDU			0x00000020
#define AEM_STREAM_INFO_FLAGS_TALKER_FAILED			0x00000040
#define AEM_STREAM_INFO_FLAGS_NO_SRP				0x00000100
#define AEM_STREAM_INFO_FLAGS_IP_FLAGS_VALID		0x00080000
#define AEM_STREAM_INFO_FLAGS_IP_SRC_PORT_VALID		0x00100000
#define AEM_STREAM_INFO_FLAGS_IP_DST_PORT_VALID		0x00200000
#define AEM_STREAM_INFO_FLAGS_IP_SRC_ADDR_VALID		0x00400000
#define AEM_STREAM_INFO_FLAGS_IP_DST_ADDR_VALID		0x00800000
#define AEM_STREAM_INFO_FLAGS_NOT_REGISTERING_SRP	0x01000000
#define AEM_STREAM_INFO_FLAGS_STREAM_VLAN_ID_VALID	0x02000000
#define AEM_STREAM_INFO_FLAGS_CONNECTED				0x04000000
#define AEM_STREAM_INFO_FLAGS_MSRP_FAILURE_VALID	0x08000000
#define AEM_STREAM_INFO_FLAGS_STREAM_DEST_MAC_VALID	0x10000000
#define AEM_STREAM_INFO_FLAGS_MSRP_ACC_LAT_VALID	0x20000000
#define AEM_STREAM_INFO_FLAGS_STREAM_ID_VALID		0x40000000
#define AEM_STREAM_INFO_FLAGS_STREAM_FORMAT_VALID	0x80000000
